...
function make_album(artist: string, title: string, tracks?: number) { // The function should take in an artist name and an // album title, and it should return a Object containing these two pieces of // information 
